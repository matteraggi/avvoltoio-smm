...
const SquealRankByViewsInverse = () => {
  ...
  const getComments = () => {
    const url =
      baseUrl +
      `api/squeal-rank-views-inverse/${clients.login}/?page=${pageNum}&size=${size}`;
    fetch(url, {
      method: "GET",
      headers: {
  ...
  return (
    <section key={9} className="flex flex-col w-[350px]">
      <h2 className="text-black">Less Seen</h2>
      <List
        sx={{
          width: "100%",
...
export default SquealRankByViewsInverse;
