...
const SquealRankByPositive = () => {
  ...
  const getComments = () => {
    const url =
      baseUrl +
      `api/squeal-rank-positive/${clients.login}/?page=${pageNum}&size=${size}`;
    fetch(url, {
      method: "GET",
      headers: {
  ...
  return (
    <section key={4} className="flex flex-col w-[350px]">
      <h2 className="text-black">Most Liked</h2>
      <List
        sx={{
          width: "100%",
...
export default SquealRankByPositive;
