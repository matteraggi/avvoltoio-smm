            ...
            <>
              <div className="relative mt-2 w-50" onClick={getClients}>
                ...
                <Transition
                  ...
                  leaveTo="opacity-0"
                >
                  <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-50 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                    {arrayVIPS.map((vip) => {
                      return (
                        <Listbox.Option
                          key={vip._id}
                          className={({ active }) =>
                            classNames(
                              active
                                ...
                                : "text-gray-900",
                              "relative cursor-default select-none py-2 pl-3 pr-9 w-50"
                            )
                          }
                          value={vip}
                        >
