...
const SquealRankByPosNegRateoInverse = () => {
  ...
  const getComments = () => {
    const url =
      baseUrl +
      `api/squeal-rank-posneg-rateo-inverse/${clients.login}/?page=${pageNum}&size=${size}`;
    fetch(url, {
      method: "GET",
      headers: {
  ...
  return (
    <section key={0} className="flex flex-col w-[350px]">
...
export default SquealRankByPosNegRateoInverse;
