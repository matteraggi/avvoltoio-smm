...
const SquealRankByNegative = () => {
  ...
  const getComments = () => {
    const url =
      baseUrl +
      `api/squeal-rank-negative/${clients.login}/?page=${pageNum}&size=${size}`;
    fetch(url, {
      method: "GET",
      headers: {
  ...
  return (
    <section key={3} className="flex flex-col w-[350px]">
      <h2 className="text-black">Most Hated</h2>
      <List
        sx={{
          width: "100%",
...
export default SquealRankByNegative;
